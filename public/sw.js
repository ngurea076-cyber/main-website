const CACHE='shop-ict-laravel-v1'; const OFFLINE='/offline';
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll([OFFLINE,'/manifest.webmanifest','/app-icon.jpg']))));
